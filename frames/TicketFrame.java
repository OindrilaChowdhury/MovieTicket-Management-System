...
public class TicketFrame extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(command.equals(insertBtn.getText()))
		{
			...
			t.setTicketCounter(ticketCounterTF.getText());
			t.setTicketQuality(ticketQualityTF.getText());
			t.setTicketQuantity(ticketQuantityTF.getText());
			t.setTicketPrice(Double.parseDouble(ticketPriceTF.getText()));
			
			//u.setUserId(empIdTF.getText());
			//u.setPassword(x+"");
			
			//if(((ticketQTF.getText()).equals("Manager")) || ((empDesignationTF.getText()).equals("manager")))
			//{
				//u.setStatus(0);
			//}
			//else
			...
			JOptionPane.showMessageDialog(this, "Inserted, ticketCounter: "+ticketCounterTF.getText()+"and ticketQuality: "+ticketQualityTF.getText()+"and ticketQuantity: "+ticketQuantityTF.getText()+"and ticketPrice: "+ticketPriceTF.getText());
		...
		{
			tr.deleteFromDB(ticketCounterTF.getText());
